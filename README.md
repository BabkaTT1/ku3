#ИНФОРМАЦИЯ 
Студент: Кодкина Анна Сергеевна 
Группа: ИКБО-24-24 
...
1. Разработан ассемблер и интерпретатор для учебной виртуальной машины (УВМ).
2. Создано CLI-приложение ассемблера. Реализовано разбор текстового
представления команд и трансляцию в промежуточное представление. По требованиям ниже:
Требования:
